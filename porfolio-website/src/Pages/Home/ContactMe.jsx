    ...
    return (
        <section id="Contact" className="contact--section">
            <div>
                ...
                <h2>Contact Me</h2>
                <p className="text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis voluptatibus optio fugiat in blanditiis repellendus recusandae facere quisquam placeat, itaque repellat laboriosam consectetur. Obcaecati autem voluptates enim dolore consequuntur corrupti!</p>
            </div>
            <form className="contact--form--container">
                ...
                <label htmlFor="message" className="contact--label">
                        ...
                        id="message"
                        rows="8"
                        placeholder="To type your message ... "/>
                    </label>
